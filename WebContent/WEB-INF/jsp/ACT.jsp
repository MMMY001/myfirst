...
<div style="width: 1200px;height: auto;margin: auto;margin-top: 30px;">
    ...
    <div style="width: 100%; height: auto;text-align: center;margin-top: 20px;">
        <span style="font-size: 20px; font-weight: bold;font-family: 宋体;">动作游戏</span>
    </div>
    <!-- 第一人称射击 -->

        <ul style="width: 100%;height: auto;">
            <li style="width: 100%;height:200px;margin-top: 5px;position: relative;float: left;">
                <div style="float: left;margin: 28px 10px;"><img src="${pageContext.request.contextPath}/image/monster-header.jpg"
                                                                 style="width: 324px;height: 151px;"/></div>
                <div style="float: left;margin: 28px 10px;">
                    <div>
                        <h1>怪物猎人世界<i class="layui-icon" style="font-size: 20px; color: #FF5722;">&#xe756;</i></h1>
                    </div>
                    ...
                    <div style="margin-top: 30px;">
                        <a href="${pageContext.request.contextPath}/gamejsp/jpmonster.action" class="layui-btn  layui-btn-normal">进入专题</a>
                    </div>
                </div>
            </li>

            <li style="width: 100%;height:200px;margin-top: 5px;position: relative;float: left;">
                <div style="float: left;margin: 28px 10px;"><img src="${pageContext.request.contextPath}/image/MSE-header.jpg"
                                                                 style="width: 324px;height: 151px;"/></div>
                <div style="float: left;margin: 28px 10px;">
                    <div>
                        <h1>合金装备:幸存<i class="layui-icon" style="font-size: 20px; color: #FF5722;">&#xe756;</i></h1>
                    </div>
                    <div style="margin-top: 20px;">
                        <span> 畅玩指数</span>
                        <i class="layui-icon" style="font-size: 20px; color: #FFB800;">&#xe658;</i>
                    ...
                    <div style="margin-top: 30px;">
                        <a href="${pageContext.request.contextPath}/gamejsp/jpMSE.action" class="layui-btn  layui-btn-normal">进入专题</a>
                    </div>
                </div>
            </li>
            ...
            <li style="width: 100%;height:200px;margin-top: 5px;position: relative;float: left;">
                ...
                <div style="float: left;margin: 28px 10px;">
                    <div>
                        <h1>逃出生天<i class="layui-icon" style="font-size: 20px; color: #FF5722;">&#xe756;</i></h1>
                    </div>
                    <div style="margin-top: 20px;">
                        <span> 畅玩指数</span>
                        <i class="layui-icon" style="font-size: 20px; color: #FFB800;">&#xe658;</i>
                    ...
                    <div style="margin-top: 30px;">
                        <a href="${pageContext.request.contextPath}/gamejsp/jpAWO.action" class="layui-btn  layui-btn-normal">进入专题</a>
                    </div>
                </div>
            </li>

            <li style="width: 100%;height:200px;margin-top: 5px;position: relative;float: left;">
                <div style="float: left;margin: 28px 10px;"><img src="${pageContext.request.contextPath}/image/GTA5-header.jpg"
                                                                 style="width: 324px;height: 151px;"/></div>
                <div style="float: left;margin: 28px 10px;">
                    <div>
                        <h1>侠盗猎车5<i class="layui-icon" style="font-size: 20px; color: #FF5722;">&#xe756;</i></h1>
                    </div>
                    <div style="margin-top: 20px;">
                        <span> 畅玩指数</span>
                        <i class="layui-icon" style="font-size: 20px; color: #FFB800;">&#xe658;</i>
                    ...
                    <div style="margin-top: 30px;">
                        <a href="${pageContext.request.contextPath}/gamejsp/jpGTA5.action" class="layui-btn  layui-btn-normal">进入专题</a>
                    </div>
                </div>
            </li>
        </ul>
