...
<div style="width: 1200px;height: auto;margin: auto;margin-top: 30px;">
    ...
    <div style="width: 100%; height: auto;text-align: center;margin-top: 20px;">
        <span style="font-size: 20px; font-weight: bold;font-family: 宋体;">第一人称射击</span>
    </div>
    <!-- 第一人称射击 -->

        <ul style="width: 100%;height: auto;">
            <li style="width: 100%;height:200px;margin-top: 5px;position: relative;float: left;">
                <div style="float: left;margin: 28px 10px;"><img src="${pageContext.request.contextPath}/image/ghtheader.jpg"
                                                                 style="width: 324px;height: 151px;"/></div>
                <div style="float: left;margin: 28px 10px;">
                    <div>
                        <h1>幽灵行动<i class="layui-icon" style="font-size: 20px; color: #FF5722;">&#xe756;</i></h1>
                    </div>
                    ...
                    <div style="margin-top: 30px;">
                        <a href="${pageContext.request.contextPath}/gamejsp/jpghost.action" class="layui-btn  layui-btn-normal">进入专题</a>
                    </div>
                </div>
            </li>

            <li style="width: 100%;height:200px;margin-top: 5px;position: relative;float: left;">
                <div style="float: left;margin: 28px 10px;"><img src="${pageContext.request.contextPath}/image/FARCRY5-header.jpg"
                                                                 style="width: 324px;height: 151px;"/></div>
                <div style="float: left;margin: 28px 10px;">
                    <div>
                        <h1>孤岛惊魂5<i class="layui-icon" style="font-size: 20px; color: #FF5722;">&#xe756;</i></h1>
                    </div>
                    <div style="margin-top: 20px;">
                        <span> 畅玩指数</span>
                        <i class="layui-icon" style="font-size: 20px; color: #FFB800;">&#xe658;</i>
                    ...
                    <div style="margin-top: 30px;">
                        <a href="${pageContext.request.contextPath}/gamejsp/jpFARCRY5.action" class="layui-btn  layui-btn-normal">进入专题</a>
                    </div>
                </div>
            </li>

            <li style="width: 100%;height:200px;margin-top: 5px;position: relative;float: left;">
                <div style="float: left;margin: 28px 10px;"><img src="${pageContext.request.contextPath}/image/siege-header.jpg"
                                                                 style="width: 324px;height: 151px;"/></div>
                <div style="float: left;margin: 28px 10px;">
                    <div>
                        <h1>彩虹六号:围攻<i class="layui-icon" style="font-size: 20px; color: #FF5722;">&#xe756;</i></h1>
                    </div>
                    <div style="margin-top: 20px;">
                        <span> 畅玩指数</span>
                        <i class="layui-icon" style="font-size: 20px; color: #FFB800;">&#xe658;</i>
                    ...
                    <div style="margin-top: 30px;">
                        <a href="${pageContext.request.contextPath}/gamejsp/jpsiege.action" class="layui-btn  layui-btn-normal">进入专题</a>
                    </div>
                </div>
            </li>

            <li style="width: 100%;height:200px;margin-top: 5px;position: relative;float: left;">
                <div style="float: left;margin: 28px 10px;"><img src="${pageContext.request.contextPath}/image/COD-header.jpg"
                                                                 style="width: 324px;height: 151px;"/></div>
                <div style="float: left;margin: 28px 10px;">
                    <div>
                        <h1>使命召唤14<i class="layui-icon" style="font-size: 20px; color: #FF5722;">&#xe756;</i></h1>
                    </div>
                    <div style="margin-top: 20px;">
                        <span> 畅玩指数</span>
                        <i class="layui-icon" style="font-size: 20px; color: #FFB800;">&#xe658;</i>
                    ...
                    <div style="margin-top: 30px;">
                        <a href="${pageContext.request.contextPath}/gamejsp/jpCOD14.action" class="layui-btn  layui-btn-normal">进入专题</a>
                    </div>
                </div>
            </li>
        </ul>
