...
<%
    ...
    session.setAttribute("page_id", 001);
    ...
    <div class="layui-side layui-bg-black">
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="test">
                <li class="layui-nav-item ">
                    <a class="" href="${ pageContext.request.contextPath }/accoutindex.action"
                       style="text-decoration: none">个人中心首页</a>
                </li>
                <li class="layui-nav-item "><a href="${ pageContext.request.contextPath }/myOrders.action"
                                               style="text-decoration: none">我的订单</a>
                </li>
                <li class="layui-nav-item layui-this"><a href="${ pageContext.request.contextPath }/myGames.action"
                                                         style="text-decoration: none">我的游戏</a></li>
                <li class="layui-nav-item "><a href="${ pageContext.request.contextPath }/myRecharge.action"
                                               style="text-decoration: none">充值中心</a>
                </li>
                <li class="layui-nav-item"><a href="${ pageContext.request.contextPath }/mySafety.action"
                                              style="text-decoration: none">安全中心</a></li>
            </ul>
        </div>
    </div>
                            ...
                            <tr>
                                ...
                                <td style="text-align: center;">
                                    <a href="#" class="btn btn-primary btn-xs" data-toggle="modal"
                                       data-target="#gamesEditDialog" onclick="downLoad(${row.order_id})">下载</a>
                                </td>
                                    <%--  <a href="#"
...
<script>
    ...
    function downLoad(id) {
        $.ajax({
            ...
            , type: "POST" // 方法类型
            //  , dataType: "json"  返回值类型
            , url: "${ pageContext.request.contextPath }/findgameUrl.action"  // url
            , data: {game_id: id}
